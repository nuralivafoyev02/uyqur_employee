...
export function PreferencesPanel() {
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="grid gap-2.5 sm:grid-cols-3">
          {copy.settings.languageOptions.map((option) => {
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  <p className="text-sm font-semibold text-app-text">{option.label}</p>
                  {isActive ? (
                ...
                <p className="mt-1.5 text-[12px] leading-5 text-app-text-muted">{option.hint}</p>
              </button>
            );
          })}
        </div>
      ...
      <div className="space-y-2.5">
        <div>
          <p className="text-[13px] font-semibold text-app-text">{copy.settings.themeLabel}</p>
          <p className="text-[13px] text-app-text-muted">
            {copy.settings.currentSelection}:{" "}
