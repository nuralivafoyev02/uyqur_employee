...
const COPY: Record<AppLanguage, PlansCopy> = {
  uz: {
    ...
    create: {
      ...
      description: "Sarlavha, xodim va deadline bilan vazifani bir necha soniyada yarating.",
      quickHint: "Avval vazifa nomini yozing, keyin xodim va deadline belgilang.",
